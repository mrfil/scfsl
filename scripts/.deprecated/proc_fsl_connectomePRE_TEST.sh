...
do
  ...
  STUDY_DATDIR=${STUDY_DATA_DIR}/${sub}/ses-A/Analyze/${STUDY_DTIPTH}/
  #location of bedpost directory
  STUDY_BEDPOSTDIR=${RESULTS_DIR}/${sub}/ses-A/DTI.bedpostX/
  #location of freesurfer subject data
  STUDY_FSDIR=${STUDY_SUBJECTS_DIR}/
  #location of connectome output
  STUDY_CONDIR=${RESULTS_DIR}/${sub}/ses-A/${STUDY_CONN_PATH}

#local TEMPORARY data locations for processing                                             
  DATDIR=${DATA_DIR}/${sub}/ses-A/DTI/analyses/
  RESDIR=${DATA_DIR}/${sub}/ses-A/ConnFSL
  FSDIR=${DATA_DIR}
  DATBEDPOSTDIR=${DATA_DIR}/${sub}/ses-A/DTI/analyses.bedpostX/
...
flirt -cost mutualinfo -dof 6 -in ${DATDIR}nodif_brain.nii.gz -ref ${STUDY_DATA_DIR}/${sub}/ses-A/Analyze/MPRAGE/IMG_brain.nii -omat FSdiff2rage.mat -out FSdiff_in_rage.nii.gz
...
SUITS_parc_file=${STUDY_DATA_DIR}/${sub}/ses-A/Analyze/MPRAGE/iw_Lobules-SUIT_u_a_IMG_brain_seg1.nii
...
flirt -cost mutualinfo -dof 6 -in ${DATDIR}nodif_brain.nii.gz -ref ${STUDY_DATA_DIR}/${sub}/ses-A/Analyze/MPRAGE/IMG_brain.nii -omat diff2rage.mat -out diff_in_rage.nii.gz  
